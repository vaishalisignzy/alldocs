...
## [Entity Onboarding GET Request](https://docs-preproduction.signzy.tech/entity-onboarding-get#right-to-left-support)

You will need to [login](https://docs-preproduction.signzy.tech/) before sending request. You are required to pass the access token received from the login call, as authorization header in the Entity Onboarding GET Request request along with essentials and task
	...
	"result": {
		"idCards": [{
			...
			},
			{
				...
				"issueDate": "..issueDate..",
				"state": "..state..",
				"purpose": ["..purpose(POI / POA / POI, POA).."],
				"verify": "..true / false..",
				"verificationStatus": {
					"verified": "true / false",
					"message": "..message..",
...
[![Run in Postman](https://run.pstmn.io/button.svg)](https://www.getpostman.com/run-collection/d9a7336937b723940f8d)

Code samples corresponding to the above example for creating a request for Entity Onboarding GET Request\
